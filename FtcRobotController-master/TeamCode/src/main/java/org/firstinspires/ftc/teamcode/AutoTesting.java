...
@Autonomous(name="Autonomous Power Shots Version 1.0.7.0", group ="Autonomous")
...
public class AutoTesting extends LinearOpMode
{
    ...
    AutoTesting.RingDeterminationPipeline pipeline;
    ...
    public void runOpMode(){
        ...
        pipeline = new AutoTesting.RingDeterminationPipeline();
    ...
    public void Strafe(double power, long time){  //STRAFES LEFT BY DEFAULT
        BackRight.setPower(power*0.5);
        FrontLeft.setPower(power*0.5);
        FrontRight.setPower(-power*0.7); //Changed from 0.5, it was uneven when testing
